              ...
              <div class="text-container titre2">
                ...
                <?php foreach ($tech3 as $item3): ?>
                  <div class="col">
                    <div class="card clir">
                      <img
                        src="assets/image/techniqueGlo/<?=$item3['id_technique_glo']?>/1.jpg"
                        class="card-img-top tete"
                        alt="..."
                      />
                      <div class="card-body">
                  ...
                  <div class=" container jumbotron bg-dark pilfont">
                    ...
                    <p class="lead">Productivité : <?= $item5['productivite'] ?></p>
                    <p class="lead">Adaptation : <?= $item5['adaptation'] ?></p>
                    <p class="lead">Mitigation : <?= $item5['mitigation'] ?></p>
                  </p>
                </div>
            <?php  endforeach;?>
            ...
            <?php $tech4 = $requete -> getTechniqueGlo2($item2['id_agri_glo']);?>
                ...
                <div class="col">
                  <div class="card clir">
                    ...
                    <img
                    class="card-img-top tete"
                      src="assets/image/techniqueGlo/<?=$item4['id_technique_glo']?>/1.jpg"
